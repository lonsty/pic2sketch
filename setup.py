...
setup(
    name='pic2sketch',
    description="A command line kit to convert a picture to a sketch.",
    ...
    url= 'https://github.com/lonsty/pic2sketch',
    download_url=(
        f'https://github.com/lonsty/'
        f'pic2sketch/archive/{version}.tar.gz'
    ),
    keywords=[
